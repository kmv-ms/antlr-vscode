...
class ANTLRv4Parser extends Parser_1.Parser {
    static TOKEN_REF = 1;
    static RULE_REF = 2;
    static LEXER_CHAR_SET = 3;
    static DOC_COMMENT = 4;
    static BLOCK_COMMENT = 5;
    static LINE_COMMENT = 6;
    static INT = 7;
    static STRING_LITERAL = 8;
    static UNTERMINATED_STRING_LITERAL = 9;
    static BEGIN_ARGUMENT = 10;
    static BEGIN_ACTION = 11;
    static OPTIONS = 12;
    static TOKENS = 13;
    static CHANNELS = 14;
    static IMPORT = 15;
    ...
    static ID = 52;
    static WS = 53;
    static END_ARGUMENT = 54;
    static UNTERMINATED_ARGUMENT = 55;
    static ARGUMENT_CONTENT = 56;
    static END_ACTION = 57;
    static UNTERMINATED_ACTION = 58;
    static ACTION_CONTENT = 59;
    static UNTERMINATED_CHAR_SET = 60;
    static RULE_grammarSpec = 0;
    static RULE_grammarType = 1;
    static RULE_prequelConstruct = 2;
    static RULE_optionsSpec = 3;
    static RULE_option = 4;
    static RULE_optionValue = 5;
    static RULE_delegateGrammars = 6;
    static RULE_delegateGrammar = 7;
    static RULE_tokensSpec = 8;
    static RULE_channelsSpec = 9;
    static RULE_idList = 10;
    static RULE_namedAction = 11;
    static RULE_actionScopeName = 12;
    static RULE_actionBlock = 13;
    static RULE_argActionBlock = 14;
    static RULE_modeSpec = 15;
    static RULE_rules = 16;
    static RULE_ruleSpec = 17;
    static RULE_parserRuleSpec = 18;
    static RULE_exceptionGroup = 19;
    static RULE_exceptionHandler = 20;
    static RULE_finallyClause = 21;
    static RULE_rulePrequel = 22;
    static RULE_ruleReturns = 23;
    static RULE_throwsSpec = 24;
    static RULE_localsSpec = 25;
    static RULE_ruleAction = 26;
    static RULE_ruleModifiers = 27;
    static RULE_ruleModifier = 28;
    static RULE_ruleBlock = 29;
    static RULE_ruleAltList = 30;
    static RULE_labeledAlt = 31;
    static RULE_lexerRuleSpec = 32;
    static RULE_lexerRuleBlock = 33;
    static RULE_lexerAltList = 34;
    static RULE_lexerAlt = 35;
    static RULE_lexerElements = 36;
    static RULE_lexerElement = 37;
    static RULE_labeledLexerElement = 38;
    ...
    static RULE_labeledElement = 47;
    static RULE_ebnf = 48;
    static RULE_blockSuffix = 49;
    static RULE_ebnfSuffix = 50;
    static RULE_lexerAtom = 51;
    static RULE_atom = 52;
    static RULE_notSet = 53;
    static RULE_blockSet = 54;
    static RULE_setElement = 55;
    static RULE_block = 56;
    static RULE_ruleref = 57;
    static RULE_characterRange = 58;
    static RULE_terminalRule = 59;
    static RULE_elementOptions = 60;
    static RULE_elementOption = 61;
    static RULE_identifier = 62;
    static ruleNames = [
    ...
    static VOCABULARY = new VocabularyImpl_1.VocabularyImpl(ANTLRv4Parser._LITERAL_NAMES, ANTLRv4Parser._SYMBOLIC_NAMES, []);
    get vocabulary() {
    ...
    static _serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03>\u0283\x04\x02" +
    ...
    static _serializedATNSegment1 = "\u0224\x03\x02\x02\x02\u0229k\x03\x02\x02\x02\u022A\u022B\x075\x02\x02" +
